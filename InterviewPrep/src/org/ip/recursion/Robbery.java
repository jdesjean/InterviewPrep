...
public class Robbery {
	public static void main(String[] s) {
		RoberyMaximizer[] maximizers = new RoberyMaximizer[]{new RecursiveRoberyMaximizer(), new DPRoberyMaximizer(), new DPRoberyMaximizer2()};
	...
	public static class DPRoberyMaximizer2 implements RoberyMaximizer {
