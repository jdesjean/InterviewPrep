...
public class RecursiveInOrderReducer<T extends Comparable<T>> implements BooleanReducer{
	private BooleanVisitor<T> reducer;
	private Node<T> root;
	public RecursiveInOrderReducer(Tree<T> tree, BooleanVisitor<T> reducer) {
		this.root = tree.root();
